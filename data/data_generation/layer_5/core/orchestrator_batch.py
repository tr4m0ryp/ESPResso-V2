"""
Batch Processing Extension for Layer 5 Orchestrator

Handles processing records in batches with incremental I/O writing.
"""
...
def monkey_patch_orchestrator():
    """Add batch processing method to Layer5Orchestrator."""
    from data.data_generation.layer_5.core.orchestrator import Layer5Orchestrator
    
    # Add the new method to the class
    Layer5Orchestrator.run_pipeline_batch = run_pipeline_batch
    
    logger.info("Batch processing method patched into Layer5Orchestrator")


# Auto-patch when module is imported
monkey_patch_orchestrator()
