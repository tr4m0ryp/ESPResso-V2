"""Synonym map: LLM material names -> canonical reference names.

Data-only module imported by material_aliases.py. Each entry maps
a non-canonical name to a reference name in base_materials.parquet.
"""

# Shorthand aliases for long reference names used repeatedly
